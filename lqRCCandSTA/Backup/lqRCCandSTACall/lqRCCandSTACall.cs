...
namespace liuqi
{
    ...
    public class lqRCCandSTACall
    {
        ...
        public static void lqRCCandSTACallF(string[] date1, double[] data1, string[] date2, double[] data2, string[] date3, double[] data3, string[] date4, double[] data4,int chuangchang,int buchang,int weizhi,bool zjjnjd,bool bd,double defaultvalue)
        {
            ...
            if(zjjnjd)
            {
                ...
                System.IO.StreamWriter Filexsnjd = new System.IO.StreamWriter(AppDomain.CurrentDomain.BaseDirectory + "\\" + "相对标定系数及自检内精度.txt",false);
                for (int ii = 0; ii < cs; ii++)
                {
                ...
                if (bd)//同时输出相对标定后的结果
                {
                    ...
                    System.IO.StreamWriter Fileout1 = new System.IO.StreamWriter(AppDomain.CurrentDomain.BaseDirectory + "\\" + "第1路-相对标定后.txt", false);
                    System.IO.StreamWriter Fileout2 = new System.IO.StreamWriter(AppDomain.CurrentDomain.BaseDirectory + "\\" + "第2路-相对标定后.txt", false);
                    System.IO.StreamWriter Fileout3 = new System.IO.StreamWriter(AppDomain.CurrentDomain.BaseDirectory + "\\" + "第3路-相对标定后.txt", false);
                    System.IO.StreamWriter Fileout4 = new System.IO.StreamWriter(AppDomain.CurrentDomain.BaseDirectory + "\\" + "第4路-相对标定后.txt", false);
                    int wz;
                    for (int ii = 0; ii < zcd; ii++)
                    {
                        wz=FH[0,0]+ii;
